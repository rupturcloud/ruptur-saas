...
```bash
# Stripe API Keys
STRIPE_SECRET_KEY=sk_test_SUBSTITUA_PELA_SUA_CHAVE_STRIPE
STRIPE_PUBLISHABLE_KEY=pk_test_SUBSTITUA_PELA_SUA_CHAVE_PUBLICA_STRIPE
STRIPE_WEBHOOK_SECRET=whsec_SUBSTITUA_PELO_SEU_WEBHOOK_SECRET_STRIPE
